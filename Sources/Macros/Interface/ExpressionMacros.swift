...
public macro addBlocker<T>(_ value: T) -> T = #externalMacro(module: "MacrosImplementation", type: "AddBlocker")
...
public macro stringify<T>(_ value: T) -> (T, String) =
  #externalMacro(module: "MacrosImplementation", type: "StringifyMacro")
...
/// #warning("...").
@freestanding(expression)
public macro myWarning(_ message: String) = #externalMacro(module: "MacrosImplementation", type: "WarningMacro")
