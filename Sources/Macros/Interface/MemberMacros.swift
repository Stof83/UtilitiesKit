...
public macro CaseDetection() = #externalMacro(module: "MacrosImplementation", type: "CaseDetectionMacro")


// MARK: - Safe Codable
@attached(member, names: named(CodingKeys), named(init))
public macro SafeCodable() = #externalMacro(module: "MacrosImplementation", type: "SafeCodableMacro")

@attached(peer)
public macro CodableEnum<T: Hashable>(default: T) = #externalMacro(module: "MacrosImplementation", type: "CodableEnum")

// MARK: - Custom Codable

@attached(member, names: named(CodingKeys))
public macro CustomCodable() = #externalMacro(module: "MacrosImplementation", type: "CustomCodable")

@attached(peer)
public macro CodableKey(name: String) = #externalMacro(module: "MacrosImplementation", type: "CodableKey")

// MARK: - Meta Enum

@attached(member, names: named(Meta))
public macro MetaEnum() = #externalMacro(module: "MacrosImplementation", type: "MetaEnumMacro")

// MARK: - New Type

@attached(member, names: named(RawValue), named(rawValue), named(init(_:)))
public macro NewType<T>(_: T.Type) = #externalMacro(module: "MacrosImplementation", type: "NewTypeMacro")
