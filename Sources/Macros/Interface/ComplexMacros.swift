...
public macro DictionaryStorageProperty() =
  #externalMacro(module: "MacrosImplementation", type: "DictionaryStoragePropertyMacro")
...
public macro Observable() = #externalMacro(module: "MacrosImplementation", type: "ObservableMacro")

@attached(accessor)
public macro ObservableProperty() =
  #externalMacro(module: "MacrosImplementation", type: "ObservablePropertyMacro")
